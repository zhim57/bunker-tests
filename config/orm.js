...
var orm = {
  ...
  read2: function (req, cb) {
    var queryString = "SELECT * FROM ?? where ?? = ?";
    // console.log("queryString for orm.read : " + queryString + tableInput);
    return connectionQuery(queryString, [req.table, req.cond,req.u_email], function (err, result) {
      if (err) {
        throw err;
      }
      console.log("result received");
  ...
  read4: function (req, cb) {
    ...
    var queryString = "SELECT * FROM " +req.table +"  WHERE u_email ="+ req.u_email;
  ...
  create: function (table, cols, vals, cb) {
    console.log("request passed step3");
